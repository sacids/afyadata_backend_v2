...
class DiseaseAjaxDatatableView(AjaxDatatableView):
    ...
    column_defs = [
        {'name': 'name', 'title': 'Disease' ,'visible': True, 'searchable': False, },
...
class SpecieAjaxDatatableView(AjaxDatatableView):
    ...
    column_defs = [
        {'name': 'name', 'title': 'Specie' ,'visible': True, 'searchable': False, },
        {'name': 'actions', 'title': 'Action', 'visible': True, 'className': 'w-12 text-left', 'placeholder': 'True', 'searchable': False, },
    ]
...
class ClinicalSignAjaxDatatableView(AjaxDatatableView):
    ...
    column_defs = [
        {'name': 'name', 'title': 'Clinical Sign' ,'visible': True, 'searchable': False, },
        {'name': 'actions', 'title': 'Action', 'visible': True, 'className': 'w-12 text-left', 'placeholder': 'True', 'searchable': False, },
    ]
...
class ClinicalResponseAjaxDatatableView(AjaxDatatableView):
    ...
    column_defs = [
        {'name': 'name', 'title': 'Response' ,'visible': True, 'searchable': False, },
        {'name': 'actions', 'title': 'Action', 'visible': True, 'className': 'w-12 text-left', 'placeholder': 'True', 'searchable': False, },
    ]
